...
date: 2020-08-10T16:30:32-04:00
draft: false
---

By Hongtao Hao, originally posted on [his blog](https://hongtaoh.com/en/2020/06/05/get-started-with-hugo/). You can find the GitHub Repo of this tutorial website at https://github.com/hongtaoh/hugo-tutorial.
...
{{<figure src="https://hongtaoh.com/media/netlify/deploy-1.png" title="Create a new GitHub Repo" width="70%">}}

Then do the following:

{{<figure src="https://hongtaoh.com/media/enblog/new-github-repo.png" width="100%">}}

You can use any name you want. Choose "public" rather than "private". Then click "Create repository".

You'll see this:

{{<figure src="https://hongtaoh.com/media/enblog/repo-https.png" width="100%">}}
...
{{<figure src="https://d33wubrfki0l68.cloudfront.net/0e9f9cefe968382536d4e4baa66e49945ad2694c/e20ef/images/hosting-and-deployment/hosting-on-netlify/netlify-signup.jpg" title="Source：Hugo" width="100%">}}

Click "Authorize application":

{{<figure src="https://d33wubrfki0l68.cloudfront.net/66276caf9e5deee836ba60fab50f78f6074e3ca0/0cc43/images/hosting-and-deployment/hosting-on-netlify/netlify-first-authorize.jpg" title="Source：Hugo" width="100%">}}

Click "New site from Git":

{{<figure src="https://hongtaoh.com/media/netlify/netlify-new-site-from-git.png" width="100%">}}

Authorize application again (if you are using Netlify for the first time):

{{<figure src="https://d33wubrfki0l68.cloudfront.net/dd85bd12e419baeb7ef56e45c43235d2004ce341/77531/images/hosting-and-deployment/hosting-on-netlify/netlify-authorize-added-permissions.jpg" title="Source：Hugo" width="100%">}}
...
{{<figure src="https://hongtaoh.com/media/netlify/netlify-create-a-new-site-github.png" title="Deployment source should be Github" width="100%">}}

Then choose the GitHub repository you just created. 

Set the Deploy this way:

{{<figure src="https://hongtaoh.com/media/enblog/deploy-setting.png" width="100%">}}
...
{{<figure src="https://hongtaoh.com/media/enblog/netlify-domain-settings.png" width="100%">}}

The url seems very ugly. Lest change it. Click "Domain settings" (as is shown above). Click on "Options", and then "Edit site name":

{{<figure src="https://hongtaoh.com/media/enblog/netlify-edit-site-name.png" width="100%">}}

Then you can input a name you like, as long as it is still available:

{{<figure src="https://hongtaoh.com/media/enblog/netlify-edit-site-name-02.png" width="100%">}}
